...
use super::{
    allocate_string, define_data, install_constructor_function, install_function, number_format,
...
pub(super) fn install<H: Host>(
    ...
    let constructor = install_constructor_function(heap, builtins, "Number", 1, constructor::<H>);
