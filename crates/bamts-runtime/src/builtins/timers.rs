//! Node-compatible `setTimeout`/`clearTimeout`, installed only when the host
//! exposes a [`crate::TimerProvider`]. The builtins validate and coerce their
//! arguments; the machine owns the live timer table, ordering, and identifiers.
