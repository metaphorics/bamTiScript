...
- [ ] G3: Every applicable stable TypeScript 7.0.2 compiler, toolchain, CLI, and historical-compatibility obligation has an observed PASS receipt
  ...
  RESIDUAL: 2026-09-03 layered whole-document census at release binary (seed 600613, N=400 of 12045 BLOCKING_FAIL javascript rows; replicator calibrated 57/57 EQUAL on PASS rows, validating pairing, echo-strip, framing, and CLI-vs-worker equivalence): WHITESPACE_ONLY 54, FIELD_INIT 29, COMMENT 27, DECORATOR 14, EXPORT_ELISION 2, OTHER_CODE 133, WOULD_PASS 5 (4 with sourcemap=true), COMPILE_FAIL 3; skips multi-unit 50, declaration-config 53, non-ts-source 25, outfile-config 5. No framing-only rows exist because the comparator's blank-sensitive document compare surfaces framing blanks as content diffs. Work order by mass: brace/paren whitespace shape, spurious field-init synthesis (`this.x = void 0`), comment drops, legacy decorator strategy.
